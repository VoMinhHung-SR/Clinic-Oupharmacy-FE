    ...
    return (
        <Box component={Paper} elevation={4} className="ou-text-center ou-p-10 ou-h-[100%]">
            ...
            <Box className="ou-flex ou-justify-between ou-mb-5">
                <SkeletonListLineItem count={1} height="32px" className="ou-w-[40%] ou-pr-2"/>
                <SkeletonListLineItem count={1} height="32px" className="ou-w-[10%] ou-px-2"/>
                <SkeletonListLineItem count={1} height="32px" className="ou-w-[10%] ou-px-2"/>
                <SkeletonListLineItem count={1} height="32px" className="ou-w-[10%] ou-px-2"/>
                <SkeletonListLineItem count={1} height="32px" className="ou-w-[15%] ou-px-2"/>
                <SkeletonListLineItem count={1} height="32px" className="ou-w-[15%] ou-pl-2"/>
            </Box>
            <Box>
...
export default SkeletonMedicineList