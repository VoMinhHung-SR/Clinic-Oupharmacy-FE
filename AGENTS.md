...
This project is indexed by GitNexus as **Clinic-Oupharmacy-FE** (2653 symbols, 4429 relationships, 162 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
