...
This project is indexed by GitNexus as **Clinic-Oupharmacy-FE** (3141 symbols, 5077 relationships, 151 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
